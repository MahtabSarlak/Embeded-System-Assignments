###########################################################################
## Makefile generated for Simulink model 'slave_model'. 
## 
## Makefile     : slave_model.mk
## Generated on : Thu Jan 21 01:09:45 2021
## MATLAB Coder version: 5.0 (R2020a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/slave_model.elf
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/slave_model.elf
...
DEFINES_ = -DMODEL=slave_model -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0 -DCLASSIC_INTERFACE=0 -DALLOCATIONFCN=0 -DTID01EQ=0 -DTERMFCN=1 -DONESTEPFCN=1 -DMAT_FILE=0 -DMULTI_INSTANCE_CODE=0 -DINTEGER_CODE=0 -DMT=0 -DXCP_CUSTOM_PLATFORM -DEXIT_FAILURE=1 -DEXTMODE_DISABLEPRINTF -DEXTMODE_DISABLETESTING -DEXTMODE_DISABLE_ARGS_PROCESSING=1 -DSTACK_SIZE=64 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DRT -DMW_TIMERID=1 -DMW_PRESCALAR=1024 -DMW_TIMERCOUNT=3036 -DMW_SCHEDULERCOUNTER=5 -D_RTT_BAUDRATE_SERIAL0_=9600 -D_RTT_ANALOG_REF_=0
...
DEFINES_STANDARD = -DMODEL=slave_model -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = slave_model.o MW_ArduinoHWInit.o io_wrappers.o MW_PWMDriver.o arduinoAVRScheduler.o
...
%.o : $(START_DIR)/slave_model_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/slave_model_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slave_model_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/slave_model_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


slave_model.o : $(START_DIR)/slave_model_ert_rtw/slave_model.c
	$(CC) $(CFLAGS) -o "$@" "$<"
